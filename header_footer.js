        ...
        <div class="flex justify-between items-center border-b border-gray-200 py-6">');
            ...
            document.write(`<div class="hidden md:flex items-center justify-end"> \
                ...
                for (var i=0; i < Bouton.length; i++){
                    document.write(`<li><a class="hidden sm:block btn btn-transparent" \
                        href="`, Bouton[i].href,`">`, Bouton[i].nom,`</a></li> `);
                }       

                // Bouton déroulant
                for (var i=0; i < Bouton_d.length; i++){
                    document.write(`<li class = "deroulant"> <a>`, Bouton_d[i].nom,` </a>
                        <ul class ="sous">`);
                            for (var j=0; j < Bouton_d[i].liste.length; j++){
                                document.write(`<li><a href="`,Bouton_d[i].liste[j].href,`">`,Bouton_d[i].liste[j].nom,`</a></li>`);
                            }
                        document.write(`</ul>
                    </li>`);
                }
